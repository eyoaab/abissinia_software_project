    ...
    return BlocListener<SliderBloc, SliderState>(
      listener: (context, state) {
        if (state is SliderAddLoadingState) {
          _showLoadingDialog("Adding Slider...");
        } else if (state is AddSliderState) {
          _dismissLoadingDialog();
          _clearAllFields();
          showCustomSnackBar(context, 'Slider added successfully!', true);
          ...
          appBar: AppBar(
            ...
            leading: IconButton(
              ...
              onPressed: () => Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => MainPage(selectedIndex: 4, isAdmin: true),
                ),
              ),
            ),
